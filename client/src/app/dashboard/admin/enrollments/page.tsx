...
export default function EnrollmentsPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (selectedEnrollment) {
        // Edit mode: only update status/elective toggle
  ...
  // Get current batch of the selected bulk offering to show only students from that batch
      ...
      >
        ...
        <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800 space-y-3">
          ...
          {!bulkOfferingId ? (
            ...
            <p className="text-[10px] font-mono text-zinc-400 dark:text-zinc-500 uppercase italic">
              No students found in batch "{targetBatchObj?.code || ''}". Assign students to this batch first!
            </p>
          ) : (
